                ...
                <div className={styles.aboutWrapper}>
                    <div className={styles.aboutTextBlock}>
                        ...
                        <p className={styles.description}>
                            Студрада ІПСА в партнерстві з ІТ-компаніями проводить IASA Champ ‘24, онлайн-змагання для студентів, за двома напрямами: Data Science і Software Engineering.
                        </p>
