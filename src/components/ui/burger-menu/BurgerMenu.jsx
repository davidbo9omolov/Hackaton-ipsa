            ...
            <div className={`${styles.dropBlock} ${toggle ? styles.dropDown : styles.dropUp}`}>
                    <div className='flex flex-col items-center justify-center h-full w-full relative '>
                        <div className={styles.navElem}>
                            ...
                            <a onClick={onHandleClick} href="#sponsors" className={styles.navLinks}  data-text="Partners">Партнери</a>
                            {/*<a onClick={onHandleClick} href="#speakers" className={styles.navLinks}  data-text="Speakers">Спікери</a>*/}
                            <a onClick={onHandleClick} href="#partners" className={styles.navLinks}  data-text="Infopartners">Інфопартнери</a>
